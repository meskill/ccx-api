...
pub enum FeeEstimateResponse {
    ...
    Eth {
        ...
        gas_limit_estimate: Option<Decimal>,
        ...
        fn deserialize_account_based_response() {
            ...
            match response {
                FeeEstimateResponse::AccountBased { fee_estimate } => {
                    assert_eq!(fee_estimate, dec!(1000000));
                }
        ...
        fn deserialize_eth_response() {
            ...
            match response {
                FeeEstimateResponse::Eth {
                    ...
                    assert_eq!(fee_estimate, dec!(420000000000000));
                    assert_eq!(gas_limit_estimate, Some(dec!(21000)));
                    assert_eq!(min_gas_price, dec!(1000000000));
                    assert_eq!(min_gas_limit, dec!(21000));
                    assert_eq!(max_gas_limit, dec!(8000000));
                    assert_eq!(min_gas_increase_by, dec!(1100000000));
                    assert!(eip1559.is_some());

                    let eip1559_data = eip1559.unwrap();
                    assert_eq!(eip1559_data.base_fee, dec!(15000000000));
                    assert_eq!(eip1559_data.gas_used_ratio, dec!(0.5));
                    assert_eq!(eip1559_data.safe_low_miner_tip, Some(dec!(1000000000)));
                    assert_eq!(eip1559_data.standard_miner_tip, Some(dec!(2000000000)));
                }
